...
export declare function getServerVIP(placeID: number): Promise<[price: number, universeID: number]>;
export declare function getGamepassInfo(gpID: number): Promise<[price: number, sellerID: number, productID: number]>;
